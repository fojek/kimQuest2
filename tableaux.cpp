...
int chargerTableaux(TABLEAU * tableau)
{
    ...
    tableau[numT].texteParag[4] = "deau de l'histoire fantastique dont VOUS SEREZ L'HÉROÏNE ! ";
    ...
    tableau[numT].texteParag[1] = "la mode. Elle était accompagnée de ses pages: l'un, grand et mince, ";
    ...
    tableau[numT].texteParag[2] = "champignon s'est tout à fait dissipée à présent, ne       :_.-:`:-._;";
    ...
    tableau[numT].texteChoix[2] = "                       1. pour recommencer ...";
    tableau[numT].texteChoix[3] = "";
    tableau[numT].texteChoix[4] = "";
    ...
    tableau[numT].texteChoix[3] = "";
    tableau[numT].texteChoix[4] = "         GAME OVER! 1. pour recommencer.";
    ...
    tableau[numT].texteParag[2] = "lui. « Grmmblbl! Je n'ai peut-être pas vu ceux que tu cherches, grrr!";
    tableau[numT].texteParag[3] = "Mais je sais où se trouve quelqu'un qui pourra t'aider. Aharr ! »";
    tableau[numT].texteParag[4] = "   Kim Pendragon sentit son courage se raffermir. Peut-être en aurait-";
    tableau[numT].texteParag[5] = "il été autrement, si elle avait su ce qui l'attendait ...";
    tableau[numT].texteChoix[0] = "";
    tableau[numT].texteChoix[1] = "                     CHAPTER ONE - COMPLETED!";
    tableau[numT].texteChoix[2] = "                  Appuyez sur 1. pour continuer";
    tableau[numT].texteChoix[3] = "";
    tableau[numT].texteChoix[4] = "";
    ...
    tableau[numT].texteParag[4] = "";
    tableau[numT].texteParag[5] = "";
    tableau[numT].texteChoix[0] = "1";
    tableau[numT].texteChoix[1] = "2";
    tableau[numT].texteChoix[2] = "";
    tableau[numT].texteChoix[3] = "";
    tableau[numT].texteChoix[4] = "";
